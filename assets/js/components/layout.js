        ...
        <div class="footer__top">
          ...
          <div class="footer__brand">
            ...
            <div class="footer__socials">
              <a href="https://instagram.com" class="footer__social-link" target="_blank" rel="noopener noreferrer" aria-label="Instagram">
                <svg width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
                  <path d="M8 0C5.829 0 5.556.01 4.703.048 3.85.088 3.269.222 2.76.42a3.9 3.9 0 0 0-1.417.923A3.9 3.9 0 0 0 .42 2.76C.222 3.268.087 3.85.048 4.7.01 5.555 0 5.827 0 8.001c0 2.172.01 2.444.048 3.297.04 1.169.175 1.75.333 2.222a3.9 3.9 0 0 0 .923 1.417 3.9 3.9 0 0 0 1.417.923c.47.188 1.05.324 1.902.364.853.037 1.126.047 3.297.047 2.172 0 2.444-.01 3.298-.048 1.17-.04 1.75-.175 2.222-.333a3.9 3.9 0 0 0 1.417-.923 3.9 3.9 0 0 0 .923-1.417c.188-.47.324-1.05.364-1.902.038-.853.047-1.126.047-3.297 0-2.172-.01-2.444-.048-3.298-.04-1.17-.175-1.75-.333-2.222a3.9 3.9 0 0 0-.923-1.417A3.9 3.9 0 0 0 13.24.42c-.47-.188-1.05-.324-1.902-.364C10.444.01 10.17 0 8 0zm0 1.541c2.137 0 2.39.008 3.23.046.78.035 1.204.166 1.486.275.373.145.64.319.92.599.28.28.453.546.598.92.11.281.24.705.275 1.485.039.843.047 1.096.047 3.231s-.008 2.389-.047 3.232c-.035.78-.166 1.203-.275 1.485a2.5 2.5 0 0 1-.599.919c-.28.28-.546.453-.92.598-.28.11-.704.24-1.485.276-.843.038-1.096.047-3.232.047s-2.39-.009-3.233-.047c-.78-.036-1.203-.166-1.485-.276a2.5 2.5 0 0 1-.92-.598 2.5 2.5 0 0 1-.6-.92c-.109-.281-.24-.705-.275-1.485-.038-.843-.046-1.096-.046-3.233s.008-2.388.046-3.231c.036-.78.166-1.204.276-1.486.145-.373.319-.64.599-.92.28-.28.546-.453.92-.598.282-.11.705-.24 1.485-.276.738-.034 1.024-.044 2.515-.045zm0 2.489a4.01 4.01 0 1 0 0 8.02 4.01 4.01 0 0 0 0-8.02zm0 5.864a1.853 1.853 0 1 1 0-3.707 1.853 1.853 0 0 1 0 3.707zM11.586 3.7a.82.82 0 1 0 0 1.639.82.82 0 0 0 0-1.64z"/>
                </svg>
              </a>
              <a href="https://linkedin.com" class="footer__social-link" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn">
                <svg width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
                  <path d="M0 1.146C0 .513.526 0 1.175 0h13.65C15.474 0 16 .513 16 1.146v13.708c0 .633-.526 1.146-1.175 1.146H1.175C.526 16 0 15.487 0 14.854V1.146zm4.943 12.248V6.169H2.542v7.225h2.401zm-1.2-8.212c.837 0 1.358-.554 1.358-1.248-.015-.709-.52-1.248-1.342-1.248-.822 0-1.359.54-1.359 1.248 0 .694.521 1.248 1.327 1.248h.016zm4.908 8.212V9.359c0-.216.016-.432.08-.586.173-.431.568-.878 1.232-.878.869 0 1.216.662 1.216 1.634v3.865h2.401V9.25c0-2.22-1.184-3.252-2.764-3.252-1.274 0-1.845.7-2.165 1.193v.025h-.016a5.54 5.54 0 0 1 .016-.025V6.169h-2.4c.03.678 0 7.225 0 7.225h2.4z"/>
                </svg>
              </a>
              <a href="https://facebook.com" class="footer__social-link" target="_blank" rel="noopener noreferrer" aria-label="Facebook">
                <svg width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
                  <path d="M16 8.049c0-4.446-3.582-8.05-8-8.05C3.58 0-.002 3.603-.002 8.05c0 4.017 2.926 7.347 6.75 7.951v-5.625h-2.03V8.05H6.75V6.275c0-2.017 1.195-3.131 3.022-3.131.876 0 1.791.157 1.791.157v1.98h-1.009c-.993 0-1.303.621-1.303 1.258v1.51h2.218l-.354 2.326H9.25V16c3.824-.604 6.75-3.934 6.75-7.951z"/>
                </svg>
              </a>
              <a href="https://youtube.com" class="footer__social-link" target="_blank" rel="noopener noreferrer" aria-label="YouTube">
                <svg width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
                  <path d="M8.051 1.999h-.089c-.822.003-1.758.006-2.772.014-1.034.008-1.865.02-2.477.037a3.9 3.9 0 0 0-2.617.962A3.9 3.9 0 0 0 .1 5.624c-.035.78-.051 1.637-.051 2.376 0 .738.016 1.595.051 2.376a3.9 3.9 0 0 0 .962 2.617 3.9 3.9 0 0 0 2.617.962c.612.017 1.442.03 2.478.038 1.014.008 1.95.011 2.772.014h.09c.823-.003 1.759-.006 2.772-.014 1.034-.008 1.866-.02 2.478-.038a3.9 3.9 0 0 0 2.617-.962 3.9 3.9 0 0 0 .962-2.617c.035-.78.051-1.637.051-2.376 0-.738-.016-1.595-.051-2.376a3.9 3.9 0 0 0-.962-2.617 3.9 3.9 0 0 0-2.617-.962c-.611-.018-1.441-.03-2.478-.038-1.012-.008-1.949-.011-2.772-.014zm-.466 7.426V4.693l4.316 2.366-4.316 2.366z"/>
                </svg>
              </a>
            </div>
          </div>
